...
def execute_command(command_str, socket: socket.socket, user: str, user_perms: PermissionLevel, args: list, client_sender = None):
    ...
    if command_name in command_registry:
        ...
        cmd[0](socket, user, args, client_sender)
